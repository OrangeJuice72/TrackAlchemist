...
export const ERAS = [
  ...
  'Early 1970s Soul Era',
  'Mid 1970s Disco Era',
  'Late 1970s Punk Era',
  'Early 1980s Synthwave Era',
  'Mid 1980s Arena Pop Era',
  'Late 1980s New Jack Swing Era',
  'Golden Age 1990-1993',
  'Mid 1990s Boom Bap Era',
  'Late 1990s Neo-Soul Era',
  'Y2K Club Era',
  'Early 2000s Pop-Rap Era',
  'Mid 2000s Bloghouse Era',
  'Late 2000s Electro Pop Era',
  '2010 Blog Era',
  'Early 2010s EDM Explosion',
  'Mid 2010s Trap Wave',
  'Late 2010s Streaming Era',
  '2020 Bedroom Pop Era',
  '2020s Viral Short-Form Era',
  'Lo-Fi Internet Radio Era',
  'Retro-Futurist 2080s',
  'Dusty Cassette Era',
  'VHS Neon Era',
  'Underground Mixtape Era',
  'Luxury Nightclub Era',
  'Post-Apocalyptic Future Era',
  'Space Colony Era',
  'Arcade Golden Age Era',
  'Cyberpunk Megacity Era',
  'Analog Studio Era',
  'Festival Mainstage Era',
  'Afterhours Warehouse Era',
  'Sunset Beach Party Era',
  'Rainy Midnight City Era',
  'Modern Playlist-Core Era'
];
